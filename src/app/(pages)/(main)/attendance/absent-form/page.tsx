        ...
        <div className="flex flex-1 flex-col px-[4%] items-center pb-4">
                        ...
                        <div className="text-m text-[black]] dark:text-[#black] font-medium flex-col">
                            <p className="mb-3">
                                ...
                                <span className="text-yellow-600">
                                    Report all absences promptly:
                                </span>{" "}
                                Notify your supervisor or designated contact as
                            ...
                            <p className="mb-3">
                                ...
                                differentiating between excused and unexcused.
                            </p>
                            <p className="mb-3">
                                3.{" "}
                                <span className="text-yellow-600">
                                ...
                                Submit any required documentation, such as
                                doctor{"'"}s notes or family emergency
                                verification, within the specified timeframe.
                            </p>
                            <p className="mb-3">
                                4.{" "}
                                <span className="text-yellow-600">
                                    Seek approval for extended absences:
                                </span>{" "}
                                Request advance permission for planned absences
                                beyond a specific duration.
                            </p>
                            <p className="mb-3">
                                5.{" "}
                                <span className="text-yellow-600">
                                ...
                                Adhere to any established notice requirements
                            ...
                            <p className="mb-3">
                                ...
                                Inform colleagues and team members of your
                                absence and arrange for coverage, if possible.
                            </p>
                            <p className="mb-3">
                                7.{" "}
                                <span className="text-yellow-600">
                                ...
                                Be reachable during business hours for urgent
                                matters unless extenuating circumstances prevent
                                it.
                            </p>
                            <p className="mb-3">
                                8.{" "}
                                ...
                                Utilize sick leave, vacation time, or other paid
                                leave options for authorized absences.
                            </p>
                            <p className="mb-3">
                                9.{" "}
                                <span className="text-yellow-600">
                                    Comply with disciplinary actions:
                                </span>{" "}
                                Accept and follow any disciplinary measures
                                taken for exceeding absence limits or violating
                                policy guidelines.
                            </p>
                            <p className="mb-3">
                                10.{" "}
                                ...
                                If chronic absenteeism persists, explore
                                possible solutions with your supervisor or seek
            ...
            <div className="flex flex-1 flex-col bg-white dark:bg-dark w-full min-h-unit-3 items-start pt-8 pb-20 px-28 gap-4 text-[#5B5F7B] text-sm shadow-[0_4px_4px_0px_rgba(0,0,0,0.25)] rounded-lg">
                ...
                <div className="flex justify-between w-full">
                    <div className="flex text-[#5B5F7B] dark:text-[#FAF9F670] gap-2">
                        <p className="inline text-start break-words font-semibold  dark:text-[#FAF9F690] ">
                            Dear:
                        </p>
                ...
                <div className="md:grid flex flex-col grid-cols-1 md:grid-cols-2 md:grid-flow-row w-full gap-y-4 gap-x-7">
                    {basicInformation.map((info) => (
                        <div
                            key={info?.label}
                            className="w-full h-fit flex flex-wrap text-[#5B5F7B] dark:text-[#FAF9F670]"
                        >
                            <p className="w-1/2 block text-start break-words font-semibold dark:text-[#FAF9F690] ">
                                {info?.label}
                            </p>
                ...
                <div>
                    <p className="text-start font-semibold inline dark:text-[#FAF9F690]">
                        Requested day off:
                    </p>
                    <FormikDatePicker
                ...
                <div className="w-full gap-2 flex flex-col">
                    <p className="text-start break-words font-semibold dark:text-[#FAF9F690]">
                        Reason:
                    </p>
                    <Textarea
                        className="h-[100px] dark:border-[#FAF9F670]"
                        name="reason"
                ...
                <div className="w-full gap-2 flex flex-row items-center">
                    <Checkbox
                        color="warning"
                        defaultSelected={formik.values.agreeCommitment}
                        onChange={() => {
                            formik.setFieldValue(
                                "agreeCommitment",
                                !formik.values.agreeCommitment
                            );
