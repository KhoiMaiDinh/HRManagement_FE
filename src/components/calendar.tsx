...
function Calendar() {
    ...
    return (
        <div className="flex flex-1 flex-col border bg-gray-50 dark:bg-dark border-blue-700 rounded-xl overflow-hidden ">
            <BlurModal
                hideCloseButton
                title={
            ...
            <div className="flex flex-1 justify-center items-stretch">
                <div className="flex flex-1 flex-col px-2 lg:px-9 bg-gray-50 dark:bg-bar_dark rounded-l items-center border justify-center relative">
                    ...
                    <div className=" px-0 lg:px-4 justify-self-center self-center w-full">
                        ...
                        >
                            ...
                            hasHolidayDate(selectedDay) ? (
                                            ...
                                            >
                                                <div className="border p-4 border-gray-400 border-solid rounded-xl mb-4 w-full">
                                                    <div className="flex justify-between">
                                                        <a
                                                            // tabindex="0"
                                                            className="focus:outline-none text-lg font-medium leading-5 text-gray-800 dark:text-white mt-2"
                                                        >
                                                            {event.name}
                                                        </a>
                                                        <p className="text-right text-xs font-light leading-3 text-gray-500 dark:text-white">
                                                            {format(
                                                                parseISO(
                                                                    event.dateTime
                                                                ),
                                                    ...
                                                    <p className="text-sm pt-2 pl-2 leading-4 text-gray-600 dark:text-white">
                                                        {event.description}
                                                    </p>
                                                    <p className="text-sm pt-2 pl-2 leading-4 text-gray-600 dark:text-white">
                                                        {event.room}
                                            ...
                                            >
                                                <div className="border p-4 border-gray-400 border-solid rounded-xl mb-4 w-full">
                                                    <div className="flex justify-between">
                                                        <a
                                                            // tabindex="0"
                                                            className="focus:outline-none text-lg font-medium leading-5 text-gray-800 mt-2 dark:text-white"
                                                        >
                                                            Holiday
                                                        </a>
                                                    </div>
                                ...
                                <p className="text-xs font-light leading-3 text-gray-500 dark:text-white mt-5">
                ...
                <div className="lg:max-w-md flex w-full shadow-lg bg-white dark:bg-dark flex-col">
                    ...
                    <div className=" p-5 bg-white dark:bg-dark rounded-r">
                        <div className="px-4 flex items-center justify-between">
                            <span
                                // tabindex="0"
                                className="focus:outline-none  text-base font-bold text-gray-800 dark:text-[#FAF9F680]"
                            >
                            ...
                            <div className="flex items-center">
                                <button
                                    ...
                                    className="focus:text-gray-400 hover:text-gray-400 ml-3 light:text-gray-800 dark:text-white hover:dark:text-button"
                                >
                                    <svg
                        ...
                        <div className="flex items-center justify-between pt-12 overflow-x-auto flex-col">
                            <div className="grid grid-cols-7 lg:pt-6 w-full">
                                <div className="w-full flex justify-center">
                                    <p className="text-base font-medium text-center text-gray-800 dark:text-[#FAF9F680]">
                                        Mo
                                    </p>
                                </div>
                                <div className="w-full flex justify-center">
                                            ...
                                            className={`
                                                ${
                                                    ...
                                                    ${
                                                        ...
                                                        "text-gray-900 dark:text-[#FAF9F690]"
                                                    }
                                                    ${
                                                        hasEventDate(day) &&
                                                    ...
                                                    ${
                                                        hasHolidayDate(day) &&
                                                        "bg-[#593FA9] text-white dark:text-black"
                                                    }
                                                    ${
                                                        !isEqual(
                                                            day,
                                                        ...
                                                        "text-gray-400 dark:text-[#FAF9F640]"
                                                    }
                                                    ${
                                                        isEqual(
                                                            day,
                                                    ...
                                                    ${
                                                        ...
                                                        !isToday(day) &&
                                                        "bg-gray-900 dark:text-[#FAF9F690]"
                                                    }
                                                    ${
                                                        !isEqual(
                                                            day,
                                                        ...
                                                        "hover:bg-gray-200 hover:dark:text-black"
                                                    }
                                                    ${
                                                        ((isEqual(
                                                            day,
